<template>
  <b-container fluid class="page-min-height py-3">
    ...
    >
      <template #buttons>
        <b-button variant="primary" to="/board/faq/add">
          FAQ 등록
        </b-button>
      </template>
    </UiPageTitle>
    ...
    >
      ...
      <template #cell(setting)="data">
        <b-button variant="outline-secondary" class="table-inner-btn" :to="`/board/faq/${data.item.id}`">
          보기
        </b-button>
      </template>
    </b-table>
