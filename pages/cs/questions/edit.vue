<template>
  <b-container fluid class="page-min-height py-3">
    <UiPageTitle title="1:1 문의 답변달기" :breadcrumb="breadcrumb">
      <template #buttons>
            ...
            <tr>
              ...
              <td colspan="3">
                <b-img
                  thumbnail
                  fluid
                  src="https://picsum.photos/100/125/?image"
                  alt="Image 1"
                />
                <b-img
                  class="ml-2"
  ...
  computed: {
    breadcrumb () {
      const arr = [
        { label: '홈', url: '/' },
        { label: '서비스 운영관리', url: '#' },
        { label: '1:1 문의 답변달기 수정', url: this.$route.path }
      ]
      return arr
    }
  },
