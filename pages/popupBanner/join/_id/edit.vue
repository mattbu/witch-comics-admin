<template>
  <b-container fluid class="page-min-height py-3">
    <UiPageTitle title="로그인/회원가입 수정" :breadcrumb="breadcrumb">
      <template #buttons>
        <b-button variant="primary" @click="editJoin">
          수정
        </b-button>
      </template>
    </UiPageTitle>
  ...
  computed: {
    breadcrumb () {
      const arr = [
        { label: '홈', url: '/' },
        { label: '팝업/배너 관리', url: '#' },
        { label: '로그인/회원가입 수정', url: this.$route.path }
      ]
      return arr
    }
  },
