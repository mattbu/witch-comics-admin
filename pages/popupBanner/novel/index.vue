<template>
  <b-container fluid class="page-min-height py-3">
    <UiPageTitle title="소널 배너 관리" :breadcrumb="breadcrumb">
      <template #buttons>
        <b-button variant="primary" to="/popupBanner/novel/add">
          등록
        </b-button>
      </template>
    </UiPageTitle>
    <hr>
    <b-container fluid class="px-0" tag="form" @submit.prevent="totalNovelList">
      <!--필터-->
