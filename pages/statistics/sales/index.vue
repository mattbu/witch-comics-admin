  ...
  data () {
    return {
      ...
      items: [
        {
          id: 3,
          date: '2022-10-24',
          pay_for_product_count: '32',
          fixed_charge_count: '144',
          auto_payment_count: '90',
          payed_user_count: '24',
          payment_count: '10',
          figures: '10000'
        },
      ...
      fields: [
        { key: 'no', label: 'No.' },
        { key: 'date', label: '날짜' },
        { key: 'pay_for_product_count', label: '상품 결제 매출' },
        { key: 'fixed_charge_count', label: '정액제 매출' },
        { key: 'auto_payment_count', label: '자동 결제 매출' },
        { key: 'payed_user_count', label: '과금자 수' },
        { key: 'payment_count', label: '결제 건수' },
  ...
  computed: {
    breadcrumb () {
      const arr = [
        { label: '홈', url: '/' },
        { label: '통계', url: '#' },
        { label: '매출 현황', url: this.$route.path }
      ]
      return arr
    }
  },
