<template>
  <b-container fluid class="page-min-height py-3">
    <UiPageTitle title="B형 편성모듈 수정" :breadcrumb="breadcrumb">
      <template #buttons>
        <b-button variant="primary" @click="addBtype">
          수정
        </b-button>
      </template>
    </UiPageTitle>
        ...
        <table class="table border mb-0 table-layout-fixed">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3">
                <b-form-radio-group
                  v-model="form.pieceList"
                  :options="pieceListOptions"
  ...
  computed: {
    breadcrumb () {
      const arr = [
        { label: '홈', url: '/' },
        { label: '편성 모듈', url: '#' },
        { label: 'B형 편성모듈 등록', url: this.$route.path }
      ]
      return arr
    }
  },
