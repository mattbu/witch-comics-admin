<template>
  <b-container fluid class="page-min-height py-3">
    <UiPageTitle title="C형 편성모듈 관리" :breadcrumb="breadcrumb">
      <template #buttons>
        <b-button variant="primary" to="comicAdult/CtypeAdd">
          등록
        </b-button>
      </template>
    </UiPageTitle>
    ...
    <b-row class="pt-5">
      <b-col align-self="center">
        <h6>C형 편성모듈 목록 ({{ totalRows ? totalRows : '0' }})</h6>
      </b-col>
    </b-row>
    <hr class="my-2">
