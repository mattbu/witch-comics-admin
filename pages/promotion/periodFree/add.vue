<template>
  <b-container fluid class="page-min-height py-3">
    <UiPageTitle title="기간무료 등록" :breadcrumb="breadcrumb">
      <template #buttons>
        <b-button variant="primary" @click="addPeriodFree">
          등록
        </b-button>
      </template>
    </UiPageTitle>
  ...
  computed: {
    breadcrumb () {
      const arr = [
        { label: '홈', url: '/' },
        { label: '프로모션 관리', url: '#' },
        { label: '기간무료 등록', url: '/promotion/periodFree/add' }
      ]
      return arr
    }
  },
