<template>
  <b-container fluid class="page-min-height py-3">
    <UiPageTitle title="로그인 등록" :breadcrumb="breadcrumb">
      <template #buttons>
        <!-- <b-button
          variant="outline-primary"
          @click="$router.push('/promotion/login')"
        >
          취소
        </b-button> -->
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="3">
                <div class="d-inline-flex">
                  <b-form-input v-model="form.setFree" class="w-30" />
            ...
            <tr>
              <th>
                ...
                <UiTooltip
                  ...
                  description="최대 호박 입력시 최대 호박 개수를 넘겨서 지급하지않습니다."
                />
              </th>
              <td colspan="3">
                <div class="d-inline-flex">
            ...
            <tr>
              <th>
                ...
                <UiTooltip
                  target="reservation-tooltip"
                  description="최대 물약 입력시 최대 물약 개수를 넘겨서 지급하지않습니다."
                />
              </th>
              <td colspan="3">
                <div class="d-inline-flex">
  ...
  computed: {
    breadcrumb () {
      const arr = [
        { label: '홈', url: '/' },
        { label: '프로모션 관리', url: '#' },
        { label: '로그인 등록', url: this.$route.path }
      ]
      return arr
    }
  },
